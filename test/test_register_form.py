...
class RegisterFormTestCase(BaseTestCase):
    ...
    def test_validate_success_register_form(self):
        form = RegisterForm(email="nohbus.veollurma@gmail.com", name="my name", password="mysecret", confirm_password="mysecret")
        self.assertTrue(form.validate())

    def test_confirm_password(self):
        form=RegisterForm(email="nohbus.veollurma@gmail.com", name="my name", password="mysecret", confirm_password="wrongsecret")
